...
{
    private static readonly Dictionary<string, ClickerConstruct> klikers = [];
    private static readonly Dictionary<string, Thread> klikerThreads = [];
